...
activities = {
    ...
    # Artistic activities
    "Art Club": {
        "description": "Painting, drawing, and mixed media projects for creative expression",
    ...
    "Debate Team": {
        "description": "Practice debate formats, public speaking, and competitive tournaments",
